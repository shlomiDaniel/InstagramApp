...
import static android.support.constraint.Constraints.TAG;
    ...
    public void checkIfUserNameExist(final String user_name) {
        ...
        Query query = reference.child("users").orderByChild(getString(R.string.filed_user_name)).equalTo(user_name);
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (!dataSnapshot.exists()) {
                    ...
                    Toast.makeText(getActivity(), "saved user name", Toast.LENGTH_SHORT).show();
                }

                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    if (ds.exists()) {
                        Toast.makeText(getActivity(), "The user name already exist.", Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    private void setProfileWidget(final UserSetting userSetting) {
        ...
        UniversalImageLoader.setIamge(userAccountSetting.getProfile_photo(), profilePhoto, null, "");
